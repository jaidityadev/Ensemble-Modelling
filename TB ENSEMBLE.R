...
data_train <- data[Year %in% n_date[1:15]]
data_test <- data[Year %in% n_date[20]]

ggplot(data_train, aes(Year,Total.No..of.TB.Death)) +
  geom_point() + geom_smooth()
labs(x = "Year", y = "Number of People Affected by Dengue") +
  theme_ts
#Bagging 
data_ts <- ts(data_train$Total.No..of.TB.Death, frequency = 25)
